            ...
            ZStack {
                ...
                VStack {
                    ...
                    Image("tinderLabel")
                        ...
                        .padding(.vertical, 70)
                    //MARK: - LABEL
                    Text(userViewModel.getAttributedString("Khi nhấn SIGN IN, bạn đồng ý với Điều Khoản của chúng tôi. Tìm hiểu về cách chúng tôi xử lý dữ liệu của bạn trong Chính sách Quyền Riêng Tư và Chính sách Cookie của chúng tôi."))
